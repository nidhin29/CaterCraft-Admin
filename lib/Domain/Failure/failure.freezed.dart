...
class AuthFailure implements MainFailure {
  const AuthFailure();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IncorrectCredential);
}
...
class otherFailure implements MainFailure {
  const otherFailure();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is otherFailure);
}
